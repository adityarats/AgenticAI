...
def run_prompt(prompt_inputs):
 ...
 Here's an example of the expected output format:
    <sample_output>
        height: 180
        weight: 72
        goal: Marathon training with carbohydrate loading and high calorie intake for endurance performance
    ...
    <ideal_output>
        ...
        **Macros:** 650 kcal | 18g protein | 108g carbs | 16g fat

        ---

        ## PRE-WORKOUT SNACK (10:30 AM)
        *30 mins before 2-hour run*

        - White bread (60g)
        - Peanut butter (20g)
        - Apple (180g)

        **Macros:** 420 kcal | 12g protein | 54g carbs | 18g fat
        ...
        **Macros:** 890 kcal | 42g protein | 112g carbs | 20g fat
        ...
        **Macros:** 380 kcal | 20g protein | 58g carbs | 8g fat
        ...
        *Evening recovery*
        ...
        - Tomato sauce (100g)
        - Parmesan cheese (15g)
        - Side salad with olive oil dressing (150g)

        **Macros:** 760 kcal | 38g protein | 88g carbs | 24g fat

        ---

        ## EVENING SNACK (8:30 PM)
        *Optional - if needed for calorie targets*

        - Rice cakes (40g)
        - Jam (25g)
        - Banana (120g)

        **Macros:** 300 kcal | 3g protein | 74g carbs | 0.5g fat
        ...
        - Sports drink (500ml) during long runs
        - Electrolyte drink post-workout

        ## Tips for Marathon Training
        ✓ Time carbs around workouts for optimal absorption  
        ✓ Adjust portions based on training intensity  
        ✓ Practice race-day foods during long training runs  
        ✓ Include variety to prevent nutrient deficiencies
    </ideal_output>

    This example meal plan fully satisfies all mandatory requirements with exact foods, portions, and timing for each meal, plus daily totals and macronutrient breakdown. It meets all secondary criteria: macronutrient ratios support endurance performance (carbs dominate, adequate protein), total calories (3,400) align with marathon training needs for a 72kg athlete, and the format is compact and well-structured. Minor deviations in fat percentage are negligible and within acceptable ranges for endurance athletes. The plan is practical, actionable, and appropriately tailored to the task.
    """
...
def main() -> None:
    ...
    dataset = evaluator.generate_dataset(
        ...
        prompt_inputs_spec={
            ...
            "goal" : "Goal of athlete",
            "restrictions" : "Dietary restrictions for athlete",
        },
    ...
    results = evaluator.run_evaluation(
        ...
        - Meals with exact foods, porions and timing
