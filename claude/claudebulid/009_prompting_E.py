...
def run_prompt(prompt_inputs):
    ...
    Follow these steps:
    1. Closely examine the provide text.
    2. Identify each topic mentioned .
    3. Add each topic to a JSON array.
    4. Respond with the JSON array. Do not provided my other text or commentary.
    """
...
def main() -> None:
    ...
    dataset = evaluator.generate_dataset(
        ...
        prompt_inputs_spec= {
            "content": "One paragraph of text from a scholary journal written in English."
        },
    ...
    results = evaluator.run_evaluation(
        ...
        - Response should contain the JSON array nothing else.
        """
    )
